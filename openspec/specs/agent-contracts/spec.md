...
### Requirement: Roles are fixed and providers are interchangeable
...
#### Scenario: Provider substituted for a role
...
#### Scenario: Only implementation roles touch product code
...
#### Scenario: Spec-touching roles receive the house standard
...
### Requirement: Review verdicts and stable findings
...
#### Scenario: Same finding returned twice
...
### Requirement: Decisions are requested, never assumed
...
#### Scenario: Ambiguous requirement encountered
...
#### Scenario: Question re-asked after a retry
...
### Requirement: Cross-provider review by default
...
### Requirement: Reproducible standard in force
...
#### Scenario: Standard updated between runs
