...
### Requirement: REQ-2 — Repository declarations resolve to exact toolchains
...
#### Scenario: AC-3 — Polyglot repository
...
#### Scenario: AC-4 — Manifest-only declaration
...
### Requirement: REQ-3 — The complete environment is pinned per task
...
#### Scenario: AC-7 — Mutable image reference is resolved
...
#### Scenario: AC-8 — Default image updated mid-task
...
#### Scenario: AC-9 — Repository declaration changes mid-task
...
### Requirement: REQ-4 — Pinned toolchains are available before the agent starts
...
#### Scenario: AC-12 — Exact version is active
...
#### Scenario: AC-13 — Range resolves once
...
#### Scenario: AC-14 — Unsatisfiable declaration
...
### Requirement: REQ-5 — Cached installs are isolated from agent stages
...
#### Scenario: AC-15 — Later stage reuses an install
...
#### Scenario: AC-16 — Stage cannot mutate a shared install
